...
VkRenderPass createRenderPass(VulkanDeviceContext *context) {
    ...
    VkAttachmentDescription attachments[2] = {colorAttachment,
                                              depthAttachment}; // Array to hold both color and depth attachments
    ...
    VkResult createRenderPassResult = vkCreateRenderPass(context->device, &renderPassInfo, NULL, &renderPass);
